...
export async function getAccessKey (base64Token) {
...
export async function getTransactions (accessKey, startDate, endDate) {
  const now = new Date()
...
function normalizeDate (date) {
  return Math.floor((date.valueOf() - date.getTimezoneOffset() * 60 * 1000) / 1000)
}

export async function getAccounts (accessKey, startDate, endDate) {
